...
class WPUM_Blocks {
	...
	public function get_restricted_message( $widget = false ) {
		...
		$message = sprintf( __( 'AThis content is available to members only. Please <a href="%1$s">login</a> or <a href="%2$s">register</a> to view this area.', 'wp-user-manager' ), $login_page, get_permalink( wpum_get_core_page_id( 'register' ) ) );
